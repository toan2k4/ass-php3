<div class="col-md-6 ptop--30 pbottom--30">
    ...
    <div class="post--items-title" data-ajax="tab">
        ...
        <div class="nav"> <a href="#" class="prev btn-link" data-ajax-action="load_prev_world_news_posts"> <i
                    class="fa fa-long-arrow-left"></i> </a> <span class="divider">/</span> <a href="#"
                class="next btn-link" data-ajax-action="load_next_world_news_posts"> <i
            ...
            <li class="col-xs-12">
                <div class="post--item post--layout-1">
                    <div class="post--img"> <a href="{{ route('post.detail',$data1->slug )}}" class="thumb"><img
                            ...
                            href="#" class="cat">{{ $title }}</a>
                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                        <div class="post--info">
                            <ul class="nav meta">
                                {{-- <li><a href="#">Astaroth</a></li> --}}
                                <li><a
                                        href="#">{{ date('D  g:i a', strtotime($data1->created_at)) }}</a>
                                </li>
                            </ul>
                            <div class="title">
                                <h3 class="h4"><a href="{{ route('post.detail',$item->slug )}}" class="btn-link">{{ $data1->title }}</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="post--item post--layout-2">
                        <div class="post--img"> <a href="{{ route('post.detail',$item->slug )}}" class="thumb"><img
                            ...
                            <div class="post--info">
                                ...
                                <div class="title">
                                    <h3 class="h4"><a href="{{ route('post.detail',$item->slug )}}" class="btn-link">{{ $item->title }}</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
